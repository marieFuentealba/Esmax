...
from bases.models import ClaseModelo, ClaseModeloVersDos
...
class FacturaEnc(ClaseModeloVersDos):
...
class FacturaDet(ClaseModeloVersDos):
    ...
    class Meta:
        ...
        #debe tener el permiso asignado para revertir
        permissions = [
