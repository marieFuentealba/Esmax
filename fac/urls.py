...
from .views import ClienteView, ClienteNew, ClienteEdit, clienteInactivar, \
     FacturaView, facturas, ProductoView, anular_detalle_fac

from .documento import imprimir_factura_recibo, imprimir_factura_list
...
urlpatterns = [
     ...
     path('facturas/anular-detalle/<int:id>',anular_detalle_fac, name="factura_anular_detalle"),
